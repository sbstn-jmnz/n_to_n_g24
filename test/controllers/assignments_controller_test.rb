...
class AssignmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assignment" do
    assert_difference('Assignment.count') do
      post assignments_url, params: { assignment: { project_id: @assignment.project_id, worker_id: @assignment.worker_id } }
    end
  ...
  test "should update assignment" do
    patch assignment_url(@assignment), params: { assignment: { project_id: @assignment.project_id, worker_id: @assignment.worker_id } }
